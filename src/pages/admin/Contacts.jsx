...
const Contacts = () => {
  ...
  const handleStatusUpdate = async (contactId, newStatus) => {
    try {
      const response = await adminContactService.updateContactStatus(
        contactId,
        newStatus,
      );
      if (response && response.success) {
  ...
  const getStatusBadgeStyle = (status) => {
    const styles = {
      ...
      replied: 'bg-green-900 text-green-200 border-green-700',
      archived: 'bg-gray-800 text-gray-200 border-gray-600',
    };
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          >
                            ...
                            <Badge
                              className={`text-xs px-3 py-2 ${getStatusBadgeStyle(
                                contact.status,
                              )}`}
                            >
                              {adminContactService.getStatusIcon(
                                contact.status,
                              )}{' '}
                              {contact.status}
                            </Badge>
      ...
      {selectedContact && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-background rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div
              className="sticky top-0 bg-background border-b border-border flex items-center justify-between"
            ...
            >
              ...
              <div>
                ...
                <div
                  ...
                  style={{ marginTop: '0.5rem', padding: '1.5rem' }}
                >
              ...
              {selectedContact.userAgent && (
                <div>
                  ...
                  <p
                    className="text-xs font-mono bg-muted rounded"
            ...
            <div
              className="sticky bottom-0 bg-background border-t border-border flex justify-end"
