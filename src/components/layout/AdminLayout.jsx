/**
 * AdminLayout - Consistent layout for admin pages
 * Provides navigation, header, and main content area for admin dashboard
 */
    ...
    <div className="block lg:flex w-full h-full">
      ...
      >
        <div className="p-6 h-full flex flex-col">
          {/* Brand */}
          <div className="mb-8">
            <h1 className="text-xl font-bold text-foreground">EQUUS ADMIN</h1>
